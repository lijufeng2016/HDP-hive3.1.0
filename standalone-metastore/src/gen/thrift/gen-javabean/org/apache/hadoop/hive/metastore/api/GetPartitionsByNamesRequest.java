...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetPartitionsByNamesRequest implements org.apache.thrift.TBase<GetPartitionsByNamesRequest, GetPartitionsByNamesRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsByNamesRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.names = new ArrayList<String>(_list570.size);
                String _elem571;
                for (int _i572 = 0; _i572 < _list570.size; ++_i572)
                {
                  _elem571 = iprot.readString();
                  struct.names.add(_elem571);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new ArrayList<String>(_list573.size);
                String _elem574;
                for (int _i575 = 0; _i575 < _list573.size; ++_i575)
                {
                  _elem574 = iprot.readString();
                  struct.processorCapabilities.add(_elem574);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.names != null) {
        if (struct.isSetNames()) {
          oprot.writeFieldBegin(NAMES_FIELD_DESC);
          {
            ...
            for (String _iter576 : struct.names)
            {
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (String _iter577 : struct.processorCapabilities)
            {
  ...
  private static class GetPartitionsByNamesRequestTupleScheme extends TupleScheme<GetPartitionsByNamesRequest> {
      ...
      if (struct.isSetNames()) {
        {
          ...
          for (String _iter578 : struct.names)
          {
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (String _iter579 : struct.processorCapabilities)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPartitionsByNamesRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list580 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.names = new ArrayList<String>(_list580.size);
          String _elem581;
          for (int _i582 = 0; _i582 < _list580.size; ++_i582)
          {
            _elem581 = iprot.readString();
            struct.names.add(_elem581);
          }
        }
        struct.setNamesIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.processorCapabilities = new ArrayList<String>(_list583.size);
          String _elem584;
          for (int _i585 = 0; _i585 < _list583.size; ++_i585)
          {
            _elem584 = iprot.readString();
            struct.processorCapabilities.add(_elem584);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
