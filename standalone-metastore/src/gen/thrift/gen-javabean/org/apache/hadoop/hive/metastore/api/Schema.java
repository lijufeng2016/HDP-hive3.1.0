            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fieldSchemas = new ArrayList<FieldSchema>(_list316.size);
                FieldSchema _elem317;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new HashMap<String,String>(2*_map319.size);
                String _key320;
                String _val321;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Schema struct) throws org.apache.thrift.TException {
      ...
      if (struct.fieldSchemas != null) {
        oprot.writeFieldBegin(FIELD_SCHEMAS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter323 : struct.fieldSchemas)
          {
      ...
      if (struct.properties != null) {
        oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter324 : struct.properties.entrySet())
          {
      ...
      if (struct.isSetFieldSchemas()) {
        {
          ...
          for (FieldSchema _iter325 : struct.fieldSchemas)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fieldSchemas = new ArrayList<FieldSchema>(_list327.size);
          FieldSchema _elem328;
          for (int _i329 = 0; _i329 < _list327.size; ++_i329)
          {
            _elem328 = new FieldSchema();
            _elem328.read(iprot);
            struct.fieldSchemas.add(_elem328);
          }
        }
        struct.setFieldSchemasIsSet(true);
      }
