            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.compacts = new ArrayList<ShowCompactResponseElement>(_list756.size);
                ShowCompactResponseElement _elem757;
                for (int _i758 = 0; _i758 < _list756.size; ++_i758)
                {
                  _elem757 = new ShowCompactResponseElement();
                  _elem757.read(iprot);
                  struct.compacts.add(_elem757);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ShowCompactResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.compacts != null) {
        oprot.writeFieldBegin(COMPACTS_FIELD_DESC);
        {
          ...
          for (ShowCompactResponseElement _iter759 : struct.compacts)
          {
  ...
  private static class ShowCompactResponseTupleScheme extends TupleScheme<ShowCompactResponse> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ShowCompactResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (ShowCompactResponseElement _iter760 : struct.compacts)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ShowCompactResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.compacts = new ArrayList<ShowCompactResponseElement>(_list761.size);
        ShowCompactResponseElement _elem762;
        for (int _i763 = 0; _i763 < _list761.size; ++_i763)
        {
          _elem762 = new ShowCompactResponseElement();
          _elem762.read(iprot);
          struct.compacts.add(_elem762);
        }
      }
      struct.setCompactsIsSet(true);
    }
